  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="section-subtitle mt-1">Manage your account information and preferences.</p>
      </div>

      {/* Profile hero */}
      <div className="card bg-gradient-to-br from-navy-900 to-navy-700 text-white p-6">
        <div className="flex items-center gap-5">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-blue to-brand-purple flex items-center justify-center text-2xl font-extrabold shadow-glow">
            {initials}
          </div>
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <span className="flex items-center gap-1.5 px-3 py-1 bg-white/10 border border-white/15 rounded-full text-xs font-semibold capitalize">
